  ...
  const handleLogin = async () => {
    try {
      ...
      if (response.ok) {
        ...
        navigate('/admin-rJWbRV'); // Redirect to admin page
      } else {
  ...
  return (
    <div id='home'>
      <div className="flex items-center justify-center h-screen ">
        <div className="bg-white dark:bg-stone-900 pt-12 px-8 pb-4 rounded shadow-lg w-80 rounded-3xl">
          ...
          <div className='w-full mt-12'>
            <a className='w-full' href='/'>
              <Button className='w-full' variant='ghost'> <ArrowLeft className='w-4 h-4 mr-2' /> Back to Home</Button>
            </a>
          </div>
        </div>
      </div>
